...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/withered-bar-101d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/withered-bar-101d
```

A live public deployment of this template is available at [https://withered-bar-101d.templates.workers.dev](https://withered-bar-101d.templates.workers.dev)
